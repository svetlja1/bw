...
__device__ __inline__ void SHA256Transform(uint32_t s[8], uint32_t* __restrict__ w) {
...
__device__ __inline__ void RIPEMD160Transform(uint32_t s[5],uint32_t* __restrict__  w) {
...
// Key encoding
// ---------------------------------------------------------------------------------
__device__  __inline__ void _GetHash160(const unsigned char* __restrict__  pubkey, int &keyLenSkip, uint8_t* __restrict__ hash) {
...
__device__  __inline__ void _GetHash160Comp(unsigned char* pubkey, int& keyLenSkip, uint8_t* hash) {
...
__device__ __inline__ void _GetHash160(const uint32_t* x32, const uint32_t* y32, uint8_t *hash) {
...
__device__ __inline__ void _GetHash160P2SHCompFromHash(uint32_t* h, uint32_t* hash) {
